...
import com.example.rick.dummygame.Adapter.myExpImpAdapter;
import com.example.rick.dummygame.Data.AudioFile;
import com.example.rick.dummygame.utils.ApiService;
import com.example.rick.dummygame.utils.AudioFileDTO;
import com.example.rick.dummygame.utils.AudioList;
import com.example.rick.dummygame.utils.ServiceGenerator;
...
public class ExportImportActivity extends AppCompatActivity {
    ...
    boolean creerFolder(String folder_name){
        ...
        File folder = new File("/data/data/com.example.rick.dummygame.audiomanaging/"+root_folder+ "/"+folder_name);
    ...
    boolean creerRootFolder(){
        ...
        File folder = new File("/data/data/com.example.rick.dummygame.audiomanaging/"+root_folder);
        boolean success = true;
        if (!folder.exists()) {
    ...
    boolean creerAppFolder(){
        ...
        File folder = new File("/data/data/com.example.rick.dummygame.audiomanaging");
        boolean success = true;
        if (!folder.exists()) {
    ...
    void saveSharedPreferences(){
        ...
        editor.putString(downloadedFileData.getafName(),
                "/data/data/com.example.rick.dummygame.audiomanaging/"+root_folder+"/"+downloadedFileData.getafType()+
    ...
    private boolean writeResponseBodyToDisk(ResponseBody body) {
        try {
            ...
            File fileToSave = new File("/data/data/com.example.rick.dummygame.audiomanaging/"+root_folder+"/"
